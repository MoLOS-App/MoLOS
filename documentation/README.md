...
- [@molos/agent](./packages/agent.md) - Agent runtime with LLM orchestration
- [@molos/agent Quick Reference](./packages/agent-quick-reference.md) - Agent API quick reference
...
│   └── agent/                  # @molos/agent - agent framework
