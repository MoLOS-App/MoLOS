...
- **Database**: `external_modules/MoLOS-Tasks/lib/server/db/schema/tables.ts`
- **Models**: `external_modules/MoLOS-Tasks/lib/models/index.ts`
- **Repositories**: `external_modules/MoLOS-Tasks/lib/repositories/`
- **API**: `external_modules/MoLOS-Tasks/routes/api/`
- **UI**: `external_modules/MoLOS-Tasks/routes/ui/`
- **Components**: `external_modules/MoLOS-Tasks/lib/components/`
- **Config**: `external_modules/MoLOS-Tasks/config.ts`
