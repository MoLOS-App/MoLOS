-- Migration 0020: Add minimax-coding AI provider
...
CREATE TABLE IF NOT EXISTS `__new_ai_settings` (
	...
	`provider` text CHECK(provider IN ('openai', 'anthropic', 'ollama', 'openrouter', 'zai', 'groq', 'deepseek', 'google', 'mistral', 'moonshot', 'xai', 'minimax', 'minimax-coding')) DEFAULT 'openai' NOT NULL,
	`api_key` text,
