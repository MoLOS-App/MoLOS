...
<RangeCalendarPrimitive.Day
	...
	class={cn(
		...
		'[&[data-today]:not([data-selected])]:text-accent-foreground [&[data-today][data-disabled]]:text-muted-foreground data-[range-middle]:rounded-none [&[data-today]:not([data-selected])]:bg-accent',
		// range Start
