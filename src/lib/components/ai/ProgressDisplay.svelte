		...
		{#if isLoading && !isStreaming}
			<div class="flex items-center gap-3">
				...
				{#if showCancelButton}
					<button
						onclick={onCancel}
						class="focus-visible:ring-ring flex h-9 w-9 items-center justify-center rounded-full border border-border/60 bg-background text-foreground shadow-sm transition hover:bg-muted/90 hover:text-destructive focus-visible:ring-2 focus-visible:ring-offset-2"
