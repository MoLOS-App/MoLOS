...
<svelte:head>
	...
	<meta
		name="description"
		content="Set up MoLOS — the structured memory layer for AI agents. Give Claude Code, OpenCode, and your AI assistants persistent memory."
	/>
</svelte:head>
...
>
	<div class="grid w-full max-w-[1000px] items-center gap-12 lg:grid-cols-2">
		...
		>
			...
			<div class="space-y-4">
				<h1 class="text-5xl leading-[1.1] font-bold tracking-tight">
					Give Your AI a Brain<br />
					<span class="text-primary">That Never Forgets</span>
				</h1>
				<p class="text-muted-foreground max-w-md text-lg font-medium">
					The structured memory layer for Claude Code, OpenCode, and AI agents. Your AI can read
					tasks, write notes, and update projects.
				</p>
			</div>

			<div class="grid gap-5 pt-8">
				<div class="flex items-start gap-4">
					<div class="mt-1 rounded-full bg-primary/10 p-1 text-primary">
						<CheckCircle2 class="h-5 w-5" />
					</div>
					<div>
						<h3 class="font-bold">100+ MCP Tools</h3>
						<p class="text-muted-foreground text-sm">
							Your AI can create tasks, search notes, and take action.
						</p>
					</div>
				</div>
				<div class="flex items-start gap-4">
				...
				<div class="flex items-start gap-4">
					...
					<div>
						<h3 class="font-bold">Works With Your AI</h3>
						<p class="text-muted-foreground text-sm">
							Claude Code, OpenCode, OpenClaw — all MCP clients supported.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="relative" in:fly={{ y: 20, duration: 1000, delay: 200, easing: cubicOut }}>
				...
				{:else if step === 4}
					...
					>
						...
						<p class="text-muted-foreground mt-4 text-xl font-medium">
							Your AI now has persistent memory, {name}.
						</p>
						<p class="text-muted-foreground mt-2 text-sm">Connecting your AI to MoLOS...</p>
					</div>
				{/if}
			</div>
			...
			<div class="text-muted-foreground mt-8 flex justify-center gap-8">
				<div class="flex items-center gap-2">
					...
					<span class="text-[10px] font-bold tracking-widest uppercase">MCP Native</span>
				</div>
				<div class="flex items-center gap-2">
					<User class="h-4 w-4" />
					<span class="text-[10px] font-bold tracking-widest uppercase">Local-First</span>
				</div>
			</div>
		</div>
	</div>
