...
<div class="flex h-screen w-full overflow-x-hidden bg-background text-foreground">
	<Tooltip.Provider>
		...
		>
			...
			<div class="flex min-w-0 flex-1 overflow-hidden">
				...
				{:else}
					<div
						class={`flex w-full ${
							isPlayground ? 'overflow-hidden' : 'justify-center overflow-x-hidden overflow-y-auto'
						}`}
					>
						<div
							class={isPlayground
